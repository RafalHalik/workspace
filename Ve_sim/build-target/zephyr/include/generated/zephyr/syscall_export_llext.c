...
extern __weak ALIAS_OF(no_handler) void * const z_impl_eeprom_read;
extern __weak ALIAS_OF(no_handler) void * const z_impl_eeprom_write;
extern __weak ALIAS_OF(no_handler) void * const z_impl_eeprom_get_size;
